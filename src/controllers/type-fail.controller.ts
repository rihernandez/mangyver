...
import {getTypeFails, createTypeFail, ITypeFailPayload, getTypeFail} from '../repositories/type-fail.repository'
...
export default class TypeFailController {
  ...
  @Post("/")
  public async createTypeFail(@Body() body: ITypeFailPayload): Promise<TypeFail> {
