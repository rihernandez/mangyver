...
export default class ResponsableController {
  @Get("/")
  public async getResponsables(@Query() operation?: string): Promise<Array<Responsable>> {
    return getResponsables(operation);
  }

  @Post("/")
  public async createResponsable(@Body() body: IResponsablePayload): Promise<Responsable> {
