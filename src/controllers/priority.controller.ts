...
import {getPrioritys, createPriority, IPriorityPayload, getPriority} from '../repositories/priority.repository'
...
export default class PriorityController {
  ...
  @Post("/")
  public async createPriority(@Body() body: IPriorityPayload): Promise<Priority> {
