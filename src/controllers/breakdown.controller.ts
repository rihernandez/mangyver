...
import {getBreakdowns, createBreakdown, IBreakdownPayload, getBreakdown} from '../repositories/breakdown.repository'
...
export default class BreakdownController {
  ...
  @Post("/")
  public async createBreakdown(@Body() body: IBreakdownPayload): Promise<Breakdown> {
